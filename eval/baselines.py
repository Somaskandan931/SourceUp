...
def score_bm25 ( df_train: pd.DataFrame, df_test: pd.DataFrame ) -> np.ndarray :
    ...
    """
    # ================================================================
    # FIX: Normalize column names for this function
    # ================================================================
    ...
    # Alternative: Handle 'Product Name' specifically if normalization didn't catch it
    if 'product_name' not in df_test.columns and 'productname' in df_test.columns :
        df_test = df_test.rename( columns={'productname' : 'product_name'} )
    if 'product_name' not in df_train.columns and 'productname' in df_train.columns :
